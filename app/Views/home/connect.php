...
<section id="form-box" class="h-box">
    ...
    <form id="register" method="POST" action="register">
        ...
        <input id="username-i" name="username" required="required" type="text">
        <label for="name-i">Nom</label>
        <input id="name-i" name="name" required="required" type="text">
        <label for="mail-i"  >E-mail</label>
        <input id="mail-i" name="email" placeholder="exemple@hothothot.fr" required="required" type="email">
        <label for="password-i">Mot de passe</label>
        <input id="password-i" name="password" required="required" onkeyup='check();' type="password">
        <input id="conf-password-i" name="password-confirm" placeholder="Confimer votre mot de passe" required="required" onkeyup='check();' type="password">
